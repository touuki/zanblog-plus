  ...
  function widget( $args, $instance ) {  
    ...
    <div class="panel  panel-zan hidden-xs">
      <ul class="nav nav-pills pills-zan">
        <li class="active"><a href="#sidebar-categories" data-toggle="tab"><?php echo $title1; ?></a></li>
        <li><a href="#sidebar-tags" data-toggle="tab"><?php echo $title2; ?></a></li>
        <?php if ( is_home() ) { ?>
        <li><a href="#sidebar-links" data-toggle="tab"><?php echo $title3; ?></a></li>
        <?php } ?>
      </ul>
      <div class="tab-content">
        <div class="tab-pane active nav bs-sidenav fade in" id="sidebar-categories"><?php wp_list_categories('title_li=&depth=1'); ?></div>
        <div class="tab-pane fade" id="sidebar-tags"><?php wp_tag_cloud('smallest=8&largest=20&number=50'); ?></div>
        <?php if ( is_home() ) { ?>
